                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Urine Threshold</h3>
                                </div>
                         ...
                         <!-- DONUT CHART -->
                            <div class="box box-danger">
                                <div class="box-header">
                                    <h3 class="box-title">Copper Area Growth</h3>
                                </div>
                                <div class="box-body chart-responsive">
                                    <div class="chart" id="revenue-chart" style="height: 300px; position: relative;"></div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    <h3 class="box-title">Arsenic Progression</h3>
                                </div>
                                <div class="box-body chart-responsive">
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var line = new Morris.Line({
                    ...
                    data: [
                      <?php foreach($tests as $test) { ?>
                        <?php echo "{y: '$test->id', item1: $test->co2},";?>
                      <?php } ?>
                ...
                var donut = new Morris.Donut({
                    element: 'sales-chart',
                    resize: true,
                    colors: ["#F60859", "#3c8dbc"],
                    data: [
                        {label: "Above Threshold", value:  <?php echo "$UrineArsenicFailValue->FailCount";?>},
                        {label: "Safe Threshold", value:  <?php echo "$UringArsenicSafeValue->SafeCount";?>}
                    ],
                    hideHover: 'auto'
                });
                //BAR CHART
