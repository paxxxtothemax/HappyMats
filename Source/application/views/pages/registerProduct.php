    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php echo form_open('verifyProduct');?>
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="inputProductID" name='inputProductID' placeholder='Example HP-00001'>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputProductName">Product Name</label>
                                            <input type="text" class="form-control" id="inputProductName">
                                             <p class="help-block">Example Mahogany Bed.</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputProductDesc">Product Description</label>
                                            <input type="text" class="form-control" id="inputProductDesc">
                                             <p class="help-block">Example Brown Leather</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputProductPrice">Product Price</label>
                                            <input type="text" class="form-control" id="inputProductPrice" placeholder="Password">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputProductQuantity">Product Quantity</label>
                                            <input type="text" class="form-control" id="inputProductQuantity" placeholder="Password">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputProductImg">Product Image</label>
                                            <input type="file" id="inputProductImg">
