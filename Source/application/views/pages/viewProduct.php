            ...
            <aside class="right-side">
                ...
                <div class="pad margin no-print">
                    <div class="alert alert-info" style="margin-bottom: 0!important;">
                        ...
                        <b>Note:</b> This is page enhanced for Printing Product Details
                    </div>
                </div>
                ...
                <section class="content invoice">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">
                                <i class="fa fa-globe"></i> Happy Mats Inc.
                                <small class="pull-right">Date: 14/10/2014</small>
                            </h2>
                        </div><!-- /.col -->
                    </div>
                    <!-- info row -->
                    <div class="row invoice-info">
                        <div class="col-sm-4 invoice-col">
                            ...
                            <address>
                                <strong>Product ID: HP - 000001</strong><br>
                                Mahogany Bed Set<br>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <p class="lead">Total Amount Income</p>
